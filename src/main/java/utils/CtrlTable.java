...
public class CtrlTable<T> extends DefaultTableModel {
 // This code is not my property
// https://javaparasereshumanos.wordpress.com/2014/08/04/creando-un-tablemodel-reutilizable-en-swing-parte-iii/
 ...
 */
     ...
     */
    public CtrlTable(List columnIdentifiers) {
        this();
